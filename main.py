...
with open('output.txt', 'w') as f:
    p1 = subprocess.run('git log --pretty="format:%H:%an:%ae:%cD}" -- js/game_manager.js ', shell=True, stdout=f, text=True)
    #p1 = subprocess.run('git log --pretty="format:{name\':\'%H\', \'Author\':\'%an\', \'Email\':\'%ae\',\'Date\':\'%cD\'}" -- js/game_manager.js ', shell=True, stdout=f, text=True)
    
    #diff = subprocess.run('git diff cf01ca7e8bf670822c55b0a4b04cd5c2b0271b3e 3b86903e65383e30ffc836b733dcaf094c33ff10 -- js/game_manager.js', shell=True, stdout=f, text=True)
    #diff = subprocess.run('git diff -U0 --shortstat 47fd901476569f5fa384962c8d429bb1f47d5db2 298c75821c068ae7b98d3d5aa8482c39a563aa7c -- js/game_manager.js', shell=True, stdout=f, text=True)
    #diff = subprocess.run('git diff -U0 --numstat 47fd901476569f5fa384962c8d429bb1f47d5db2 298c75821c068ae7b98d3d5aa8482c39a563aa7c -- js/game_manager.js', shell=True, stdout=f, text=True)
...
gitshowcommand = "git show {}:js/game_manager.js".format(commitgraph[0]['hash'])
...
#for i in range(2):
    ...
    gitdiffcommand = "git diff -U0 --numstat {} {} -- js/game_manager.js".format(commithash0,commithash1)
